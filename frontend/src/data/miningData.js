// Comprehensive Realistic Mining & Geological Dataset for CMPDI / Coal India Limited (CIL)
...
export const GEOLOGICAL_REPORTS = [
  {
    id: 'REP-2024-0891',
...
export const MINEGPT_KNOWLEDGE_BASE = [
  {
...
export const KPI_DATA = {
  totalReports: { value: '1,482', change: '+14.2%', note: 'indexed across 8 CIL subsidiaries' },
  activeCoalfields: { value: '28', change: '8 Subsidiaries', note: '142 active mines monitored' },
  riskAlerts: { value: '6 Critical', change: '2 High, 4 Med', note: 'DGMS Action Notices pending' },
  aiQueries: { value: '3,840', change: '98.6% Accuracy', note: 'automated NLP extractions' }
};
